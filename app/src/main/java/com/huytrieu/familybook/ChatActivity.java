...
import com.huytrieu.familybook.Adapter.MessageAdapter;
import com.huytrieu.familybook.Model.Messages;
...
public class ChatActivity extends AppCompatActivity {
    ...
    ImageButton SendMessageButton,SelectImageButton;
...
//        Toast.makeText(this, messageReceiverName, Toast.LENGTH_SHORT).show();
        ...
        InputMessageText = findViewById(R.id.edt_message);

        messageAdapter = new MessageAdapter(messagesList);
        userMessagesList = findViewById(R.id.list_chat);
        ...
        rootRef.child("Users").child(messageReceiverId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ChatActivity.this).load(userThumb).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.profile)
                        .into(userChatProfileImage, new Callback() {
                            ...
                            @Override
                            public void onError() {
                                Picasso.with(ChatActivity.this).load(userThumb).placeholder(R.drawable.profile).into(userChatProfileImage);
                            }
                        });
